    ...
    return (
        <footer className="mx-8 md:container flex justify-between items-center mt-16 py-8 bg-red-">
            ...
            <div className="links flex text-xs md:text-2xl space-x-1 md:space-x-4 text-red-500 ">
                ...
                <a className="hover:text-red-400" href=""><FaFacebookF /></a>
                <a className="hover:text-red-400" href=""><AiOutlineInstagram /></a>
                <a className="hover:text-red-400" href=""><FaLinkedinIn /></a>
                <a className="hover:text-red-400" href=""><AiFillGithub /></a>
            </div>
